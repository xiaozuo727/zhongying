	...
	<div class="content">
		<ul class="banks pad-l-r-1 ">
			...
			<div class="line-height-3">
				...
				<div class="re" >
					到账卡号：
					<span class="fr" >储蓄卡：{{chuxuNum}}</span>
...
//			this.type = this.$route.query.type;
		...
		methods:{
			payYes(){
                ...
                this.axios.get(this.Global.hostUrl+'mobile/YeepaySkbSdk/FindXinyong',data,config).then(res=>{
		...
		mounted: function(){
			...
			this.axios.get(this.Global.hostUrl+'mobile/YeepaySkbSdk/findBank',data,config).then(res=>{
				console.log(res.data);
				if(res.data.error=='success'){
				    this.chuxuNum=res.data.data.banknum;
