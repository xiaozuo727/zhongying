<template>
	<div>
	<headernav headTip="实名认证" backUrl="./shsk_index"></headernav>
...
//				}
					...
					var config= {headers: {'X-Requested-With': 'XMLHttpRequest'},emulateJSON: true};
					this.axios.get(this.Global.hostUrl+'mobile/yeepaySkbSdk/SaveData',data,config).then(res=>{
						console.log(res.data);
						var th=this;
						if(res.data.error=="success"){
							th.loading=false;
							this.$router.push({path:'./upbank'})
						}else{
							th.loading=false;
							alert(res.data.msg);
						}
