<template>
	...
	<div class="content">
		...
		<ul class="line-height-2 f15">
			<li class="border-b-gray pad-5-1 flex">
				<img src="../assets/img/set_name.png" alt="" width="25">
				<p class="f1 pad-l-1">名称</p>
				<div class="color-gray">{{set.nickName}}</div>
			</li>
			<li class="border-b-gray pad-5-1 flex space-btw">
				<img src="../assets/img/set_wei.png" alt="" width="25">
				<p class="f1 pad-l-1">微信号</p>
				<div class="color-gray">{{set.user_wxnum}}</div>
			</li>
			<li class="border-b-gray pad-5-1 flex space-btw">
				<img src="../assets/img/set_ewm.png" alt="" width="25">
				<p class="f1 pad-l-1">微信二维码</p>
				<img class="bright-7" :src="set.wx_erweima" alt="" width="25" />
			</li>
			<li class="border-b-gray pad-5-1 flex space-btw">
				<img src="../assets/img/set_phone.png" alt="" width="25">
				<p class="f1 pad-l-1">手机号</p>
				<div class="color-gray">{{set.user_phone}}</div>
			</li>
			<li class="border-b-gray pad-5-1 flex space-btw">
				<img src="../assets/img/set_pwd.png" alt="" width="25">
				<p class="f1 pad-l-1">密码</p>
