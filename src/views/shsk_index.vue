<template>
	...
	<div class="content">
		...
		<ul class="f16 pad-l-r-1">
			...
			<router-link to="reward_sh" class="flex border-b-gray mar-t-b-5 pad-b-5 re">
				<img src="../assets/img/shsk_3.png" alt="" width="45" />
				<div class="f1 pad-l-1">奖金说明</div>
				<div class="arrow" style="left:-10px"> </div>
			</router-link>

			<router-link to="zh_course" class="flex border-b-gray mar-t-b-5 pad-b-5 re">
...
//		},
		...
		mounted: function(){
			...
			this.axios.get(this.Global.hostUrl+'mobile/yeepaySkbSdk/findUser',data,config).then((res) => {
				console.log(res.data);
				if(res.data.error =="success"&&res.data.msg==6){
					 this.mask=false
				}else{
                    this.mask=true
				}
