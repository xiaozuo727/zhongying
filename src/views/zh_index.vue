	...
	<div class="content">
		<div class="zhanghu-top re ">
			...
			<div class="loop re color-white center">
				...
				<div class="f30 line-height-2 pad-t-2r mar-b-1">{{Math.floor(tx.money*100)/100}}</div>
				<span id="tixian-btn" class="zh-tixian" @click="isShow">立即提现</span>
			</div>
		</div>
		<ul class="f16 line-height-2 mar-t-1">
			<router-link to="TodayShouyi" class="pad-1-2 border-b-gray flex">
				<img class="mar-r-1" src="../assets/img/zh-icon0.png" alt="" width="25" />
				<div class="f1">
					今日收益
				</div>
