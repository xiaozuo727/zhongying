	...
	<div class="content">
		...
		<div class="myuser-box re">
			...
			<div class="flex center pad-t-b-5">
				<div class="f1">
					<div class="border-r-gray flex">￥ <span class="f18 ellipsis">{{my.limit}}</span></div>
					<div class="color-gray">总收益</div>
				</div>
				<div class="f1">
					<div class="border-r-gray flex">￥ <span class="f18 ellipsis">{{my.yijiesuan}}</span></div>
					<div class="color-gray">已结算</div>
				</div>
				<div class="f1">
					<div class="flex">￥ <span class="f18 ellipsis">{{my.limit-my.yijiesuan}}</span></div>
		...
		<tixiantc :mask="mask" v-model="mask" @hideBox="isHide" @apply="applyBtn"></tixiantc>
